...
const WEB3FORMS_KEY = "7758bda7-0af4-4048-a5e1-b427672f49e5";
...
export default function Contact() {
  ...
  const contactItems = [
    { ic: "✉", lbl: "Email", val: site.email, href: `mailto:${site.email}` },
    { ic: "📞", lbl: "Phone", val: site.phone, href: `tel:${site.phone.replace(/\s/g, "")}` },
    { ic: "💬", lbl: "WhatsApp", val: "Chat instantly", href: site.socials.whatsapp },
    { ic: "in", lbl: "LinkedIn", val: "/in/asharali", href: site.socials.linkedin },
  ];
      ...
      <div className="wrap">
        ...
        <div className="contact-grid">
          <Reveal className="contact-info">
            {contactItems.map((c) => (
              <a className="ci-item glass" href={c.href} key={c.lbl}>
